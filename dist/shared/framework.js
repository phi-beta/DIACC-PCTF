...
const digital_wallet_1 = require("../digital-wallet");
const trust_registry_1 = require("../trust-registry");
/**
...
class PCTFFramework {
    constructor(frameworkId, version = '1.0.0') {
        ...
        this.infrastructureProviders = new Map();
    ...
    async initializeServiceProviders(participant) {
        switch (participant.type) {
            ...
            case types_1.ParticipantType.IDENTITY_PROVIDER:
                ...
                break;
            case types_1.ParticipantType.WALLET_PROVIDER:
                const walletProvider = new digital_wallet_1.DigitalWalletProvider(`WALLET-${participant.participantId}`, participant.participantId, digital_wallet_1.WalletType.CLOUD, // Default wallet type, could be configurable
                participant.name, participant.certificationLevel);
                this.walletProviders.set(participant.participantId, walletProvider);
                break;
            case types_1.ParticipantType.TRUST_REGISTRY:
                const trustRegistry = new trust_registry_1.TrustRegistryProvider(participant.participantId, participant.name, 'DIACC-PCTF', participant.certificationLevel);
            ...
            case types_1.ParticipantType.RELYING_PARTY:
                ...
                if (participant.certificationLevel === types_1.AssuranceLevel.LOA3 ||
                    participant.certificationLevel === types_1.AssuranceLevel.LOA4) {
                    const infraProvider = new infrastructure_1.InfrastructureServiceProvider(participant.participantId, participant.name, infrastructure_1.SecurityLevel.ENHANCED, participant.certificationLevel);
